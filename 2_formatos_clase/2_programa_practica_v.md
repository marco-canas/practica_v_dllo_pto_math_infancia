...
| **Pre-requisitos:**            | Práctica Pedagógica IV               |
| **Co-requisitos:**             | Didáctica del pensamiento matemático |
| **Horas docencia directa:**    | 96                                   |
| **Horas trabajo independiente:**| 96                                   |
| **Horas totales:**             | 192                                  |

**Profesor(a) que elaboró:**  
Astrid Elena Pineda Muriel  
**Modificada por:**  
Catalina Bermúdez Galeano  
**Correos electrónicos:**  
- astrid.pineda@udea.edu.co  
- catalina.bermudezg@udea.edu.co  
...
### **Objetivo general:**  
Promover una cultura investigativa en maestros en formación para diseñar ambientes de aprendizaje que fomenten   
el pensamiento matemático en niños de preescolar y escolar.  

### **Objetivos específicos:**  
- Orientar la formación docente en dimensiones personal, investigativa y profesional.  
- Implementar teorías sobre pensamiento matemático desde un enfoque sociocultural.  
- Diseñar e implementar propuestas pedagógicas innovadoras.  
- Reflexionar sobre los impactos cognitivos y comportamentales en los niños.  
- Promover la sistematización y divulgación de experiencias educativas.  
...
|-----------------------------|----------------------------------------|------------------------------------------------------------------------------|
| **Eje formativo y personal**| Saberes fundamentales del maestro      | Vocacionalidad, ética docente, disciplina inteligente, rol del juego.       |
| **Eje investigativo**       | Paradigmas y técnicas de investigación | Sistematización de experiencias, escritura científica, instrumentos de recolección. |
| **Eje disciplinar**         | Didáctica de las matemáticas           | Lineamientos curriculares, pensamiento numérico/espacial/métrico, secuencias didácticas. |

---

## 4. METODOLOGÍA  
### **Componentes:**  
1. **Seminario de Práctica Pedagógica:**  
   - Metodología de Seminario Investigativo (Seminario Alemán).  
   - Actividades: debates, exposiciones, talleres, protocolos.  
2. **Centro de Práctica:**  
   - Implementación de ambientes de aprendizaje presenciales.  
   - Etapas: caracterización, diseño de secuencias didácticas, evaluación.  

### **Actividades y modalidades:**  
| **Actividad**                          | **Modalidad**                |
|----------------------------------------|-------------------------------|
| Preparación de la práctica             | Docencia directa              |
| Elaboración de informes                | Trabajo autónomo              |
| Socialización de resultados            | Docencia asistida             |
...
|-----------------------------------|----------------|----------------------------|
| Seguimiento en aula               | 20%            | Durante el semestre        |
| Diario pedagógico                 | 15%            | Durante el semestre        |
| Proyecto (secuencia didáctica)    | 20%            | Semana 4-5                 |
| Sistematización                   | 15%            | Última semana              |
| Evaluación final                  | 25%            | Semana de evaluaciones     |

**Asistencia obligatoria:** Máximo 20% de faltas.  
...
- MEN (2010). *Guía 13: Aprender y Jugar*.  

### **Referencia:**  
- Chamorro, M. (2005). *Didáctica de las matemáticas para Educación Infantil*.  
- Parra-Zapata, M.M. (2015). *Participación en ambientes de modelación matemática*.  

---

## 7. PROFESORES  
| **Nombre**             | **Dependencia**       | **Formación**                              |
|------------------------|-----------------------|--------------------------------------------|
| Catalina Bermúdez Galeano | Facultad de Educación | Lic. Educación Básica, Magíster en Ciencias Exactas |

---

*Nota:* Este programa está sujeto a ajustes por situaciones institucionales.  
**Aprobado por el Consejo de la Unidad Académica.**   


  
|Centro de práctica|Número de convenio|
|------------------|------------------|
|I.E. Liceo Caucasia|VDPA-046/2021|
